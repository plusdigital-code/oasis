...
var FormioResourceEditComponent = /** @class */ (function () {
    ...
    FormioResourceEditComponent.decorators = [
        { type: Component, args: [{
                    template: "<formio [form]=\"service.form\" [url]=\"service.formUrl\" [submission]=\"service.resource\" [error]=\"triggerError\" [refresh]=\"service.refresh\" (submit)=\"onSubmit($event)\" ></formio> "
                },] },
    ];
    /** @nocollapse */
