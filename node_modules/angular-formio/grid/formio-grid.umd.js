(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@angular/router'), require('rxjs'), require('formiojs'), require('lodash'), require('ngx-bootstrap/pagination')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', '@angular/router', 'rxjs', 'formiojs', 'lodash', 'ngx-bootstrap/pagination'], factory) :
	(factory((global['formio-grid'] = {}),global.core,global.common,global.forms,global.router,global.rxjs,global.formiojs,global.lodash,global.pagination));
}(this, (function (exports,core,common,forms,router,rxjs,formiojs,lodash,pagination) { 'use strict';
...
var FormBuilderComponent = /** @class */ (function () {
    ...
    function (form) {
        ...
        this.builder = new Builder(this.builderElement.nativeElement, form, lodash.assign({ icons: 'fontawesome' }, this.options || {}));
...
var FormioGridComponent = /** @class */ (function () {
    ...
    function (query) {
        ...
        this.alerts.setAlerts([]);
        query = query || {};
        query = lodash.assign(query, this.query);
