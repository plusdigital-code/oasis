  ...
  _createClass(WebformBuilder, [{
    ...
    value: function updateComponent(component) {
      ...
      if (this.defaultValueComponent) {
        _lodash.default.assign(this.defaultValueComponent, _lodash.default.omit(component.component, ['key', 'label', 'placeholder', 'tooltip', 'validate', 'disabled', 'fields.day.required', 'fields.month.required', 'fields.year.required'])); // If default value is nested component then remove validations from its components


        if (this.defaultValueComponent.components) {
          (0, _utils.eachComponent)(this.defaultValueComponent.components, function (comp) {
            comp.validate = {};
          }, true);
        }
