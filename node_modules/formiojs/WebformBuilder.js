...
function (_Component) {
  ...
  _createClass(WebformBuilder, [{
    ...
    value: function onDrop(element, target, source, sibling) {
      ...
      if (key) {
        ...
        if (this.schemas.hasOwnProperty(key)) {
          ...
          var resource = element.getAttribute('data-group');
    ...
    key: "saveComponent",
    value: function saveComponent(component, parent) {
      var _this7 = this;
      ...
      if (index !== -1) {
        ...
        return rebuild.then(function () {
          _this7.emit('saveComponent', parentContainer[index], originalComponent);
    ...
    value: function editComponent(component, parent, isNew, isJsonEdit) {
      ...
      if (isJsonEdit && !isCustom) {
        ...
        this.editForm.form = componentClass.editForm(_lodash.default.cloneDeep(overrides));
      ...
      this.addEventListener(this.componentEdit.querySelector('[ref="saveButton"]'), 'click', function (event) {
        ...
        _this8.saveComponent(component, parent);
      });
