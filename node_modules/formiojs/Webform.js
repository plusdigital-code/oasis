...
var Webform = /*#__PURE__*/function (_NestedComponent) {
  ...
  function Webform(element, options) {
    ...
    _this2 = _super.call(this, null, getOptions(options)); // Keep track of all available forms globally.
  ...
  _createClass(Webform, [{
    ...
    value: function setSubmission(submission, flags) {
      ...
      return this.onSubmission = this.formReady.then(function () {
        ...
        if (submission._fvid && _this8._form.revisions === 'original' && submission._fvid !== _this8._form._vid && _this8.formio) {
    ...
    value: function onChange() {
      ...
      var isValid = this.checkData(value.data, flags, changed ? changed.instance : null);
    ...
    value: function submitForm() {
      ...
      return new _nativePromiseOnly.default(function (resolve, reject) {
        ...
        _this16.hook('beforeSubmit', _objectSpread(_objectSpread({}, submission), {}, {
          ...
          _this16.hook('customValidation', _objectSpread(_objectSpread({}, submission), {}, {
            component: options.component
          }), function (err) {
            if (err) {
