...
var BaseComponent = /*#__PURE__*/function (_Component) {
  ...
  function BaseComponent(component, options, data) {
    ...
    _this = _super.call(this, options, component && component.id ? component.id : null); // Determine if we are inside a datagrid.
      ...
      return actions.reduce(function (changed, action) {
        switch (action.type) {
          case 'property':
            ...
            if (!_lodash.default.isEqual(_lodash.default.get(_this13.component, action.property.value), _lodash.default.get(newComponent, action.property.value))) {
              changed = true;
            }
