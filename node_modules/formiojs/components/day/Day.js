...
var DayComponent = /*#__PURE__*/function (_BaseComponent) {
  ...
  _createClass(DayComponent, [{
    ...
    value: function createDayInput(subinputAtTheBottom) {
      ...
      this.addEventListener(this.dayInput, 'input', function () {
    ...
    value: function createYearInput(subinputAtTheBottom) {
      ...
      this.addEventListener(this.yearInput, 'input', function () {
