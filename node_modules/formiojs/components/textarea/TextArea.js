...
function (_TextFieldComponent) {
  ...
  _createClass(TextAreaComponent, [{
    ...
    value: function attachElement(element, index) {
      ...
      var settings = _lodash.default.isEmpty(this.component.wysiwyg) ? this.wysiwygDefault : this.component.wysiwyg;
      var mode = this.component.as || 'javascript'; // Attempt to add a wysiwyg editor. In order to add one, it must be included on the global scope.

      switch (this.component.editor) {
        case 'ace':
          _Formio.default.requireLibrary('ace', 'ace', 'https://cdnjs.cloudflare.com/ajax/libs/ace/1.4.1/ace.js', true).then(function (editor) {
            _this3.editor = editor.edit(element);

            _this3.editor.removeAllListeners('change');

            _this3.editor.setOptions({
              maxLines: 12,
              minLines: 12
            });
