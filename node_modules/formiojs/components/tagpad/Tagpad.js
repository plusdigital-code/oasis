...
function (_NestedComponent) {
  ...
  _createClass(Tagpad, [{
    ...
    value: function render() {
      if (this.builderMode) {
        return _get(_getPrototypeOf(Tagpad.prototype), "render", this).call(this);
      }

      return _get(_getPrototypeOf(Tagpad.prototype), "render", this).call(this, 'coming soon');
    } // build(state) {
    ...
    value: function attach(element) {
      return _get(_getPrototypeOf(Tagpad.prototype), "attach", this).call(this, element); // this.attachDrawEvents();
    ...
    value: function attachDrawEvents() {
      ...
      var mouseEnd = function mouseEnd(e) {
        ...
        _this3.addDot(_this3.getActualCoordinate({
    ...
    value: function addBackground() {
      ...
      if (this.component.image) {
        ...
        _Formio.default.makeStaticRequest(this.component.imageUrl, 'GET', null, {
          ...
          _this4.background.innerHTML = _this4.t('Background image failed to load. Tagpad doesn\'t work without background image');
    ...
    value: function setValue(dots) {
      ...
      var changed = this.hasChanged(dots, this.dataValue);
      this.dataValue = dots;
