...
var Sketchpad = /*#__PURE__*/function (_Base) {
  ...
  function Sketchpad() {
    ...
    _this.state = {
      ...
      stroke: _this.component.defaultStroke || '#333',
      fill: _this.component.defaultFill || '#ccc',
      linewidth: _this.component.defaultLineWidth || 1,
      circleSize: _this.component.defaultCircleSize || 10
    };
    ...
    value: function attach() {
      ...
      this.editSketchpad.canvas.svg.addEventListener('mousedown', function (e) {
        ...
        var mouseEnd = function mouseEnd(e) {
          ...
          _this5.editSketchpad.canvas.svg.removeEventListener('mouseup', mouseEnd);

          document.removeEventListener('mouseup', mouseEnd); //change cursor
        ...
        _this5.editSketchpad.canvas.svg.addEventListener('mouseup', mouseEnd); //this is necessary to stop drawing after mouse is up outside of canvas
    ...
    get: function get() {
      ...
      return [{
        ...
        attach: function attach(element) {
          ...
          element.style.color = _this10.state.stroke;
        ...
        attach: function attach(element) {
          var picker = new _vanillaPicker.default(element);
          element.style.color = _this10.state.fill;
