...
var NgbdAlertBasicComponent = /** @class */ (function () {
    ...
    NgbdAlertBasicComponent.prototype.ngOnInit = function () {
        ...
        this._success
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["debounceTime"])(5000))
            .subscribe(function () { return (_this.successMessage = null); });
    };
...
/* harmony import */ var _buttons_buttons_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./buttons/buttons.component */ "./src/app/component/buttons/buttons.component.ts");
...
module.exports = "<div class=\"row\">\n    <div class=\"col-md-6\">\n        <div class=\"card\">\n            <div class=\"card-body\">\n                <h3 class=\"card-title\">Quick and easy popovers</h3>\n                <h6 class=\"card-subtitle\">This is basic popovers</h6>\n                <div class=\"button-box\">\n                    <button type=\"button\" class=\"btn btn-secondary m-r-5\" placement=\"top\" ngbPopover=\"Vivamus sagittis lacus vel augue laoreet rutrum faucibus.\"\n                        popoverTitle=\"Popover on top\">\n                        Popover on top\n                    </button>\n\n                    <button type=\"button\" class=\"btn btn-secondary m-r-5\" placement=\"right\" ngbPopover=\"Vivamus sagittis lacus vel augue laoreet rutrum faucibus.\"\n                        popoverTitle=\"Popover on right\">\n                        Popover on right\n                    </button>\n\n                    <button type=\"button\" class=\"btn btn-secondary m-r-5\" placement=\"bottom\" ngbPopover=\"Vivamus sagittis lacus vel augue laoreet rutrum faucibus.\"\n                        popoverTitle=\"Popover on bottom\">\n                        Popover on bottom\n                    </button>\n\n                    <button type=\"button\" class=\"btn btn-secondary m-r-5\" placement=\"left\" ngbPopover=\"Vivamus sagittis lacus vel augue laoreet rutrum faucibus.\"\n                        popoverTitle=\"Popover on left\">\n                        Popover on left\n                    </button>\n                </div>\n            </div>\n        </div>\n    </div>\n    <div class=\"col-md-6\">\n        <div class=\"card\">\n            <div class=\"card-body\">\n                <h3 class=\"card-title\">HTML and bindings in popovers</h3>\n                <h6 class=\"card-subtitle\">Popovers can contain any arbitrary HTML, Angular bindings and even directives! Simply enclose desired content\n                    in a\n                    <code>&lt;ng-template&gt;</code> element.</h6>\n                <ng-template #popContent>Hello,\n                    <b>{{name}}</b>!</ng-template>\n                <button type=\"button\" class=\"btn btn-secondary\" [ngbPopover]=\"popContent\" popoverTitle=\"Fancy content\">\n                    I've got markup and bindings in my popover!\n                </button>\n\n            </div>\n        </div>\n    </div>\n    <div class=\"col-md-6\">\n        <div class=\"card\">\n            <div class=\"card-body\">\n                <h3 class=\"card-title\">Custom and manual triggers</h3>\n                <h6 class=\"card-subtitle\">You can easily override open and close triggers by specifying event names (separated by\n                    <code>:</code>) in the\n                    <code>triggers</code> property.</h6>\n                <button type=\"button\" class=\"btn btn-secondary\" ngbPopover=\"You see, I show up on hover!\" triggers=\"mouseenter:mouseleave\"\n                    popoverTitle=\"Pop title\"> Hover over me!</button>\n\n            </div>\n        </div>\n    </div>\n    <div class=\"col-md-6\">\n        <div class=\"card\">\n            <div class=\"card-body\">\n                <h3 class=\"card-title\">Popover visibility events</h3>\n                <h6 class=\"card-subtitle\">This is popover event</h6>\n                <button type=\"button\" class=\"btn btn-secondary\" placement=\"top\" ngbPopover=\"Vivamus sagittis lacus vel augue laoreet rutrum faucibus.\"\n                    popoverTitle=\"Popover on top\" #popover=\"ngbPopover\"> Open Popover</button>\n                Popover is currently:\n                <code>{{ popover.isOpen() ? 'open' : 'closed' }}</code>\n            </div>\n        </div>\n    </div>\n    <div class=\"col-md-6\">\n        <div class=\"card\">\n            <div class=\"card-body\">\n                <h3 class=\"card-title\">Quick and easy tooltips</h3>\n                <h6 class=\"card-subtitle\">This is Quick and easy tooltips</h6>\n                <div class=\"button-box\">\n                    <button type=\"button\" class=\"btn btn-secondary m-r-5\" placement=\"top\" ngbTooltip=\"Tooltip on top\">\n                        Tooltip on top\n                    </button>\n                    <button type=\"button\" class=\"btn btn-secondary m-r-5\" placement=\"right\" ngbTooltip=\"Tooltip on right\">\n                        Tooltip on right\n                    </button>\n                    <button type=\"button\" class=\"btn btn-secondary m-r-5\" placement=\"bottom\" ngbTooltip=\"Tooltip on bottom\">\n                        Tooltip on bottom\n                    </button>\n                    <button type=\"button\" class=\"btn btn-secondary m-r-5\" placement=\"left\" ngbTooltip=\"Tooltip on left\">\n                        Tooltip on left\n                    </button>\n                </div>\n            </div>\n        </div>\n    </div>\n    <div class=\"col-md-6\">\n        <div class=\"card\">\n            <div class=\"card-body\">\n                <h3 class=\"card-title\">HTML and bindings in tooltips</h3>\n                <h6 class=\"card-subtitle\">Tooltips can contain any arbitrary HTML, Angular bindings and even directives! Simply enclose desired content\n                    in a\n                    <code>ng-template</code> element.</h6>\n                <ng-template #tipContent>Hello,\n                    <b>{{name}}</b>!</ng-template>\n                <button type=\"button\" class=\"btn btn-secondary\" [ngbTooltip]=\"tipContent\">\n                    I've got markup and bindings in my tooltip!\n                </button>\n            </div>\n        </div>\n    </div>\n    <div class=\"col-md-6\">\n        <div class=\"card\">\n            <div class=\"card-body\">\n                <h3 class=\"card-title\">Custom and manual triggers</h3>\n                <h6 class=\"card-subtitle\">You can easily override open and close triggers by specifying event names (separated by :) in the triggers\n                    property.</h6>\n                <button type=\"button\" class=\"btn btn-secondary\" ngbTooltip=\"You see, I show up on click!\" triggers=\"click:blur\"> Click me!</button>\n            </div>\n        </div>\n    </div>\n    <div class=\"col-md-6\">\n        <div class=\"card\">\n            <div class=\"card-body\">\n                <h3 class=\"card-title\">Popover visibility events</h3>\n                <h6 class=\"card-subtitle\">This is Disabled pagination</h6>\n                <div class=\"button-box\">\n                    <button type=\"button\" class=\"btn btn-secondary m-r-5\" ngbTooltip=\"What a great tip!\" triggers=\"manual\" #t=\"ngbTooltip\" (click)=\"t.open()\">\n                        Click me to open a tooltip\n                    </button>\n                    <button type=\"button\" class=\"btn btn-secondary\" (click)=\"t.close()\">\n                        Click me to close a tooltip\n                    </button>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>"
...
var NgbdtypeheadBasicComponent = /** @class */ (function () {
    function NgbdtypeheadBasicComponent(_service) {
        ...
        this.search3 = function (text3$) {
            return text3$.debounceTime(200).map(function (term) {
                return term === ''
                    ? []
                    : statesWithFlags
